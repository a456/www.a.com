...
$(document).ready(function(){
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_projecstaff|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistprojecstaff = a;
			addtabs({num:'daoruprojecstaff',url:'flow,input,daoru,modenum=projecstaff',icons:'plus',name:'导入项目员工'});
		},
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewprojecstaff_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewprojecstaff_{rand}"></div>
<!--HTMLend-->