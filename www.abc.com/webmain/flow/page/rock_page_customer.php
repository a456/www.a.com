...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"客户号",dataIndex:"id"},{text:"客户名称",dataIndex:"name"},{text:"客户类型",dataIndex:"client_type"},{text:"业务类型",dataIndex:"business_type"},{text:"行业",dataIndex:"industry"},{text:"地址",dataIndex:"address"},{text:"地区",dataIndex:"area"},{text:"邮编",dataIndex:"postcode"},{text:"客服负责人",dataIndex:"linkname"},{text:"传真",dataIndex:"fax"},{
