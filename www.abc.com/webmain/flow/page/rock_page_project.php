...
c.setcolumns('distribution',{
    renderer:function(v,d,i){
        return ''+v+'&nbsp;<a href="javascript:;" onclick="workinghours{rand}('+i+')">分配</a>'+'&nbsp;<a href="javascript:;" onclick="operating{rand}('+i+')">操作</a>';
    }
});
operating{rand}=function(id){
    var d 	= a.getData(id);
    var bo 	= addtabs({name:'造价业务',url:'flow,page,projectreview,pnum=allall,atype=all,projcetid='+d.id+'',num:'projectreview'+d.id+''});
}
